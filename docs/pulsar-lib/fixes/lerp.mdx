---
id: lerp
title: Color Lerp Errors
---

# Color Lerp Errors
## [...Stack] attempt to call method 'Lerp' (a nil value)

This error occurs when PulsarUI is trying to create its own colour lerp functions, but it is unable to due to your server not having the necessary fixes for Metatables.
